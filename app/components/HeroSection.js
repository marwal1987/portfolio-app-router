...
export default function HeroSection() {
  return (
    <section className="py-12 flex flex-col lg:flex-row items-center justify-around">
      <div className="container flex flex-col items-center justify-center max-w-[35%] gap-12">
        <h1 className="text-4xl md:text-[4rem] tracking-wide uppercase font-bold text-stone-300 text-center">
            Versatile Front-End Developer and Linux Enthusiast with a Melodic
            Twist
        </h1>
        <p className="text-2xl text-stone-400 text-center tracking-wide ">
